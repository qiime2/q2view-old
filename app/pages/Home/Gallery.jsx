...
export default () => (
    <div>
        <Row style={{ display: 'flex'}}>
            <Col xs={6} md={4}><Gallery {...taxaThumObj}></Gallery></Col>
            <Col xs={6} md={4}><Gallery {...volThumObj}></Gallery></Col>
            <Col xs={6} md={4}><Gallery {...empThumObj}></Gallery></Col>
        </Row>
        <Row style={{ display: 'flex'}}>
            <Col xs={6} md={4}><Gallery {...sumThumObj} ></Gallery></Col>
            <Col xs={6} md={4}><Gallery {...alphaRObj} ></Gallery></Col>
            <Col xs={6} md={4}><Gallery {...alphaSObj} ></Gallery></Col>
        </Row>
    </div>
